...
class VisitorAdmin(admin.ModelAdmin):
    ...
    list_editable = ('exit_time',)

@admin.register(Room)
class RoomAdmin(admin.ModelAdmin):
    list_display = ('number', 'display_occupied_status')
    def display_occupied_status(self, obj):
        return obj.is_currently_occupied
    display_occupied_status.boolean = True
    display_occupied_status.short_description = "Зайнята зараз"
